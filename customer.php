			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">List Customer </h3>
									</div>
						...
						<!-- /PAGE HEADER -->
						<!-- DATA TABLES -->
						<a href="#table-modal" data-toggle="modal" class="btn btn-info">Tambah Customer</a>
						<!-- EXPORT TABLES -->
						<div class="row">
							<div class="col-md-12">
								<!-- BOX -->
										...
										<table id="datatable2" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
											...
											while ($data = mysql_fetch_array($query)) {
												...
												<tr class="gradeX">
													...
													<a href="delete_customer.php?id_customer=<?php echo $data['id_customer'];?>" class="btn btn-danger btn-xs" onclick="return confirm("Yakin Anda ingin Menghapus data ini ?")"><i class="fa fa-trash"></i> Hapus</a>
							  ...
							  <div class="modal-content modal-table">
								...
								<div class="modal-body">
								 <div class="box border primary">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>Tambah Customer</h4>
												<div class="tools hidden-xs">
													<a href="#box-config" data-toggle="modal" class="config">
														<i class="fa fa-cog"></i>
													</a>
											...
											<div class="box-body big">
												<form action="add-customer.php" method="post" class="form-horizontal" role="form">
												  <div class="form-group">
													<label class="col-sm-4 control-label">Nama Customer</label>
													<div class="col-sm-8">
													 <input name="nama_customer" type="text" class="form-control" placeholder="Text input">
													</div>
												  </div>
												  <div class="form-group">
													<label class="col-sm-4 control-label">Keterangan</label>
													<div class="col-sm-8">
													  <input name="keterangan" type="text" class="form-control" placeholder="Text input">
													</div>
												  </div>
