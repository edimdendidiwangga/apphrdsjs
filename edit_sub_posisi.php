											...
											<div class="box-body big">
												<div class="row">
												   <?php 
													...
													$query = mysql_query("
												        SELECT *
												        FROM sub_posisi inner join posisi
												        where sub_posisi.id_posisi=posisi.id_posisi && sub_posisi.id_sub_posisi='$id'");
													
													$data = mysql_fetch_array($query);
													
													?>
													<form action="update_sub_posisi.php" method="post" class="form-horizontal" role="
													form">
													<input type="hidden" name="id_sub_posisi" value="<?php echo $id; ?>">
													<div class="form-group">
													   <label class="control-label col-md-3">Nama Posisi<span class="required">*</span></label>
													   <div class="col-md-4">
														  <input type="hidden" class="form-control" name="id_posisi" value="<?php echo $data['id_posisi']; ?>" readonly="true">
														  <input type="text" class="form-control" value="<?php echo $data['nama_posisi']; ?>" readonly="true">
														  <span class="error-span"></span>
														 
													   </div>
													</div>
													<div class="form-group">
													   <label class="control-label col-md-3">Nama Sub Posisi<span class="required">*</span></label>
													   <div class="col-md-4">
														  <input type="text" class="form-control" name="nama_sub_posisi" value="<?php echo $data['nama_sub_posisi']; ?>">
														  <span class="error-span"></span>
														  <br><br>
