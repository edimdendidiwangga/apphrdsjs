												...
												<div class="row">
												   <?php 
													...
													$query = mysql_query("
												        SELECT *
												        FROM nilai 
												        where nilai.id_biji='$id'");
													
													$data = mysql_fetch_array($query);
													
													?>
													<form action="update_nilai.php" method="post" class="form-horizontal" role="
													form">
													<input type="hidden" name="id_biji" value="<?php echo $id; ?>">
													
													<div class="form-group">
													   <label class="control-label col-md-3">Nilai<span class="required">*</span></label>
													   <div class="col-md-4">
