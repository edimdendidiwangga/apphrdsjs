				...
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="box border purple">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>Penerimaan Karyawan</h4>
											...
											<div class="box-body big">
												<div class="row">
												   <?php 
													...
													?>
													<form action="update_diterima.php" method="post" class="form-horizontal" role="
													form">
													...
													<div class="form-group">
													   ...
													   <div class="col-md-4">
														  <input type="text" class="form-control" value="<?php echo $data['status_pengiriman']; ?>" readOnly="true">
													...
													<div class="form-group">
													   ...
													   <div class="col-md-4">
														  ...
														  <input type="text" class="form-control" placeholder="Tanggal Awal Kontrak" id="datep1" required/>   to 
														   <input type="text" class="form-control" placeholder="Tanggal Akhir Kontrak" id="datep2" onchange="myPeriod()"/>
														   <input type="hidden" name="tgl_efektif" id="v_periode" value="">
														  <span class="error-span"></span>
														  <BR><BR>
